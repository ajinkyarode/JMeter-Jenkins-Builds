pipeline {
    ...
    stages {
        ...
        stage('Execute Sanity Test') {
            steps {
              bat '''C:\\Users\\ajink\\Downloads\\apache-jmeter-5.6.2\\apache-jmeter-5.6.2\\bin\\jmeter.bat -j jmeter.save.saveservice.output_format=xml -n -t "Demo1.jmx" -l TestRes.jtl'''
            }
        }
